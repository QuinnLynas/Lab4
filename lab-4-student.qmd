...
> I am interested in NBA data. The particular data sets I am looking at include team performance (record) and team salary. I want to combine multiple data sets and analyze these two variables to see if there is some relationship. Additionally, I would like to include NBA coaches and see how they affect team outcome. I have found 2 datasets so far on Kaggle, I will link them here: https://www.kaggle.com/datasets/boonpalipatana/nba-season-records-from-every-year
